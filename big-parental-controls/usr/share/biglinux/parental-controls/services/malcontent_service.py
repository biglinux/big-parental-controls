...
from gi.repository import GLib, Gio, Malcontent


# OARS age-group presets — values are maximum content levels allowed.
# UNKNOWN=0 (unrated, no filter), NONE=1, MILD=2, MODERATE=3, INTENSE=4.
...
class MalcontentService:
    ...
    def set_app_filter(
        ...
        Args:
            uid: Target user UID.
            blocked_paths: List of absolute paths to block.
            allowed_paths: If set, only these paths are allowed (whitelist mode).
            oars_values: Dict of OARS section -> value for content filtering.
            allow_user_installation: Allow flatpak user installations.
            allow_system_installation: Allow flatpak system installations.
        """
    ...
    def set_session_limits(
        ...
        Args:
            uid: Target user UID.
            daily_start_secs: Start of allowed window in seconds from midnight.
            daily_end_secs: End of allowed window in seconds from midnight.
        """
